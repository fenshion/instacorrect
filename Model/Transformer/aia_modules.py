...
def char_convolution(inputs, kernels, kernel_features, reuse=None):
...
def positional_encoding(inputs, max_len, num_units):
...
def multihead_attention(queries, keys, num_heads=8, dropout=0,
                        causality=False):
