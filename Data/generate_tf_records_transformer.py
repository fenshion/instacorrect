...
char_vocab = get_vocab('data/vocab/char_vocab_dict.json')
word_vocab = get_vocab('data/vocab/words_vocab_dict.json')
...
for filename  in filenames:
    with io.open(filename, 'r', encoding='utf8') as fin:
        ...
        for line in fin.readlines():
            ...
            example = create_example(mistake_line, correct_line, word_vocab, char_vocab)
